...
namespace Airbnb.Infrastructure.Migrations
{
    ...
    [Migration("20260913131810_AddApartmentCustomData")]
    partial class AddApartmentCustomData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Airbnb.Domain.Models.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Airbnb.Domain.Models.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("BookedPricePerNight")
                        .HasColumnType("float");

                    b.Property<double>("BookedTotalPrice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Airbnb.Domain.Models.Apartment", b =>
                {
                    b.HasOne("Airbnb.Domain.Models.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Airbnb.Domain.Models.Booking", b =>
                {
                    b.HasOne("Airbnb.Domain.Models.Apartment", "Apartment")
                        .WithMany("Bookings")
                        .HasForeignKey("ApartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Airbnb.Domain.Models.User", "Client")
                        .WithMany()
